...
1. No Loss/Error    : Leave the percentagepacketloss,percentBitError and in both the client and server to be "0". In this case,
		      the Client and Server are functioning in the ideal case.

2.ACK Packet Bit error : Change the percentBitError in the Client in percentage levels (0-70%). Calculate
...
3.Data Packet Bit error : Change the percentBitError in the Server in percentage levels (0-70%). Calculate
		          the percentage for 49 packets and specify the no. of packets. This introduces 
		          corresponding amounts of Data Packet error in the system.

4.ACK Packet Loss : Change the percentagepacketloss in the server in percentage levels.This introduces 
		    corresponding amounts of ACK Bit error in the system.

5.Data Packet Loss : Change the percentagepacketloss in the server in percentage levels.This introduces 
		     corresponding amounts of ACK Bit error in the system.
