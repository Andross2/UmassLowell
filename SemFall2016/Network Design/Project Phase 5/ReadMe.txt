...
2.ACK Packet Bit error : Change the percentBitError in the Server in percentage levels (0-50%). 
   

3.Data Packet Bit error : Change the percentBitError in the Client in percentage levels (0-50%). 
...
5.Data Packet Loss : Change the percentagepacketloss in the Client in percentage levels.This introduces 
		     corresponding amounts of ACK Bit error in the system.
